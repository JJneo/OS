...
// 매크로
// SS, RSP, RFLAGS, RIP + ISR에서 저장하는 19개의 레지스터
...
// 테스크 풀의 상태를 관리하는 자료구조
typedef struct kTCBPoolManagerSturct
{
	// 테스크 풀에 대한 정보
	TCB* pstStartAddress;
	int iMaxCount;
...
//=============================================================================//
// 태스크 풀과 태스크 관련
//	static 함수는 task파일 내부에서만 사용함으로 외부에서 참조하지 못하도록 하는듯.
//=============================================================================//
